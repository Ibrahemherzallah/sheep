...
import {addCycleInventory, addInventory} from '@/utils/api'; // adjust path as needed
...
export const AddSaleDialog: React.FC<AddSaleDialogProps> = ({ isOpen, onClose, type, onAdd, cycle }) => {
    ...
    return (
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle style={{textAlign:'right'}}>إضافة {type === 'sheep' ? 'مبيعات' : 'مدخلات'} جديدة</DialogTitle>
                    </DialogHeader>
